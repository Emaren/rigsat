  ...
  Future<void> _checkTimesheetExistence() async {
    ...
    if (snapshot.docs.isNotEmpty) {
      ...
      Map<String, dynamic> timesheetData =
          timesheetDoc.data() as Map<String, dynamic>;
            ...
            Row(
              ...
              children: [
                ConstrainedBox(
                  ...
                  child: Image.asset('assets/RigSat.jpg',
                      alignment: Alignment.centerLeft),
                ),
                Expanded(
                  // Expanded widget is used to take remaining space
                  child: Padding(
                          ...
                          AutoSizeText(
                            ...
                            style: TextStyle(
                              ...
                              foreground: Paint()
                                ...
                                ..strokeWidth = 2
                                ..color = const Color.fromARGB(255, 171, 27,
                                    17), // Changed stroke color to red
                            ),
                          ),
                          const AutoSizeText(
                            'TIME CARD',
                                    ...
                                    onTap: () async {
                                      if (isSaved) {
                                        ...
                                        try {
                                          ...
                                          print(
                                              'Before setState - supervisorName: $supervisorName');
                                          ...
                                          print(
                                              'After setState - supervisorName: $supervisorName');
                                          ScaffoldMessenger.of(context)
